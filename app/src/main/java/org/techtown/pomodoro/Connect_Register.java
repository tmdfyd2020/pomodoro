...
public class Connect_Register extends AsyncTask<String, Long, Boolean> {
    private Context mContext = null;
    private int responseCode;

    Register activity;
    public Connect_Register(Context context){
        mContext = context;
        activity = (Register) Register.context;
    }
    ...
    protected Boolean doInBackground(String... strings) {
        String url1= "http://192.168.0.2:8080/pomodoro/index.php/register";
        ...
        try {
            ...
            String json = "{'id' : '"+ strings[0]+"', 'passwd' : '"+strings[1]+ "', 'name' : '"+
        strings[2]+"', 'email' : '"+strings[3]+"'}";
